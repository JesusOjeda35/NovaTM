...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-center mb-8 text-blue-600">📅 EDITAR DISPONIBILIDAD PROFESIONAL</h1>
                ...
                <div class="border-r pr-8">
                    ...
                    <div class="mb-6">
                        ...
                        <input 
                            ...
                            name="fecha" 
                            id="fecha"
                            value="{{ old('fecha', $disponibilidad->fecha?->format('Y-m-d')) }}"
                    ...
                    <div class="mb-6">
                        ...
                        >
                            ...
                            <option value="Lunes" @selected(old('dia_semana', $disponibilidad->dia_semana) == 'Lunes')>Lunes</option>
                            <option value="Martes" @selected(old('dia_semana', $disponibilidad->dia_semana) == 'Martes')>Martes</option>
                            <option value="Miércoles" @selected(old('dia_semana', $disponibilidad->dia_semana) == 'Miércoles')>Miércoles</option>
                            <option value="Jueves" @selected(old('dia_semana', $disponibilidad->dia_semana) == 'Jueves')>Jueves</option>
                            <option value="Viernes" @selected(old('dia_semana', $disponibilidad->dia_semana) == 'Viernes')>Viernes</option>
                            <option value="Sábado" @selected(old('dia_semana', $disponibilidad->dia_semana) == 'Sábado')>Sábado</option>
                            <option value="Domingo" @selected(old('dia_semana', $disponibilidad->dia_semana) == 'Domingo')>Domingo</option>
                        </select>
                        @error('dia_semana')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="pl-8">
                    ...
                    <div class="mb-6">
                        ...
                        <input 
                            ...
                            name="especialidad" 
                            id="especialidad"
                            value="{{ old('especialidad', $disponibilidad->especialidad) }}"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center">
                            ...
                            <input 
                                ...
                                step="0.01"
                                min="0"
                                value="{{ old('precio_consulta', $disponibilidad->precio_consulta) }}"
                                placeholder="0.00"
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center gap-4">
                            <label class="flex items-center cursor-pointer">
                                ...
                                >
                                <span class="ml-2 text-gray-700 font-semibold">Disponibilidad Activa</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <a 
                            href="{{ route('profesional.consultas') }}" 
