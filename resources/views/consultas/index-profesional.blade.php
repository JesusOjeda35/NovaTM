...
<div class="container mx-auto px-4">
    ...
    @if ($disponibilidades->count() > 0)
        ...
        <div class="mt-8 p-6 bg-blue-50 border-l-4 border-blue-500 rounded-lg">
            ...
            <p class="text-blue-700">Los productores podrán ver estas disponibilidades cuando busquen profesionales y agendarán consultas con base en estos horarios.</p>
        </div>
    @else
